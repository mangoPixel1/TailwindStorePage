...
function CheckoutForm() {
	const [inputs, setInputs] = useState([
		...
		},
		{
			...
			errorMessage: "Enter a valid US phone number (e.g., 123-456-7890 or (123) 456-7890)"
		},
		{
			id: 4,
			type: "checkbox",
		...
		},
		{
			...
			errorMessage: "Country name should contain only letters and spaces (e.g., United States)"
		},
		{
			id: 6,
			type: "text",
			...
			errorMessage: "Name can include letters, spaces, hyphens, and apostrophes only (e.g., Anne-Marie O'Neil)"
		},
		{
			id: 7,
			type: "text",
			...
			errorMessage: "Address should include letters, numbers, and common punctuation (e.g., 123 Main St., Apt #4)"
		},
		{
			id: 8,
			type: "text",
			...
			errorMessage: "Use letters, numbers, and common punctuation only (e.g., Apt 5B or Suite #101)"
		},
		{
			id: 9,
			type: "text",
			...
			errorMessage: "City name should only contain letters, spaces, apostrophes, and hyphens (e.g., Los Angeles or St. John's)"
		},
		{
			id: 10,
			type: "text",
			...
			pattern: "^[A-Z]{2}$",
			errorMessage: "Enter a 2-letter state abbreviation in uppercase (e.g., CA, TX)"
		},
		{
			id: 11,
			type: "text",
			...
			<div className="mb-5">
				...
				<div className="space-y-3">
					...
					{inputs
						...
						.map(input => (
							<CheckoutFormInput key={input.id} {...input} value={values[input.name]} handleInputChange={handleInputChange} />
						))}
				</div>
			</div>
