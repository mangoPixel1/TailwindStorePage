        ...
        featuredIndices.forEach((index) => {
          ...
          let description =
            product.description.length > 150
              ? product.description.slice(0, 149)
              : product.description;
      ...
      style={{
        backgroundImage:
          featuredProducts.length > 0 && featuredProducts[featuredIndex]
            ? `url(${featuredProducts[featuredIndex].image})`
            : "none",
      }}
    >
      ...
      <div className="flex flex-col gap-10 justify-center items-center w-full px-3 py-10 sm:py-16 md:px-12 md:py-20 lg:px-16 lg:py-24 max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg">
        <div className="flex justify-center items-center">
          <svg
            ...
            className="z-10 h-6 w-6 shrink-0 mr-5 sm:mr-10 lg:mr-20 cursor-pointer"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col justify-center items-start relative z-10">
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold">
                {featuredProducts && featuredProducts[featuredIndex].title}
              </h1>
              ...
              <p className="pb-3 text-xl">
                {featuredProducts &&
                  `$${featuredProducts[featuredIndex].price.toFixed(2)}`}
              </p>
              <button className="px-5 py-2 text-slate-200 bg-slate-600 transition duration-350 hover:bg-slate-700 rounded-sm cursor-pointer">
                <Link to={`/product/${featuredProducts[featuredIndex].id}`}>
                  Shop Now
                </Link>
              </button>
            </div>
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            className="z-10 h-6 w-6 shrink-0 ml-5 sm:mr-10 lg:ml-20 cursor-pointer"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
