  ...
  return (
    <div className="mt-20 w-full flex justify-center items-center">
      <div className="w-80 md:w-96 flex flex-col justify-items-start">
        <h1 className="mb-10 text-center text-slate-800 text-2xl font-bold tracking-tight">
        ...
        <div>
          <form onSubmit={submitLogin}>
            ...
            <button
              type="submit"
              className="w-full mt-5 bg-slate-500 hover:bg-slate-600 transition duration-300 text-slate-50 py-2 rounded-md cursor-pointer"
            >
              Sign In
            </button>
            <p className="mt-5 text-slate-500 text-center tracking-tight">
              Don't have an account?{" "}
              <button className="text-slate-600 hover:text-indigo-800 transition duration-300 font-medium cursor-pointer">
                Sign up
              </button>
            </p>
          </form>
