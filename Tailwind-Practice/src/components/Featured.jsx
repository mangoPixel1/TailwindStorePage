		...
		>
			...
			<div className="flex flex-col gap-10 justify-center items-center w-full px-3 py-10 sm:py-16 md:px-12 md:py-20 lg:px-16 lg:py-24 max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg">
				<div className="flex justify-center items-center">
					<svg xmlns="http://www.w3.org/2000/svg" className="z-10 h-6 w-6 shrink-0 mr-5 sm:mr-10 lg:mr-20 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					...
					{isLoading ? (
						...
						<div className="flex flex-col justify-center items-start relative z-10">
							...
							<p className="pb-3 text-xl">{featuredProduct && `$${featuredProduct.price.toFixed(2)}`}</p>
					...
					<svg xmlns="http://www.w3.org/2000/svg" className="z-10 h-6 w-6 shrink-0 ml-5 sm:mr-10 lg:ml-20 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
